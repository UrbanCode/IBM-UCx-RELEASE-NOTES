...
**This article was originaly published in 2017.06.01**


6.2.1.3 ifix 14 - June, 2017
============================
...
* Performance Improvements on: Managing groups, acting on tasks, completing approvals, editing tasks, loading the deployment page, calendar page and enterprise release event dashboard
* Lots of database indexes added
* Bug Fixes
