...
**This article was originaly published in 2017.07.01**


6.2.1.3 ifix 18 - July, 2017
============================
...
* Added feature to indicate if a task has previously failed
* Added a feature flag to set a maximum number of days a deployment can be scheduled in advance
* Added pagination to environment activity dialog
* Deployment execution auto update feature flag to set the frequency of the scheduled deployment auto-refresh
* Add enterprise release event notifications type and release event notifications recurring notifications
* Allow task tags edition
* Bug Fixes
