...
Timing data is now stored in the database instead of a cache making data consistent across nodes.Release Summary
---------------

  
* Replace timing cache with storing timing data in the database
