...
**This article was originaly published in 2017.09.29**


6.2.1.3 ifix 28 - September 29, 2017
====================================
...
* Fix adding wait or signal task to running deployment
* Improved performance of releases dropdown when scheduling a deployment
* Added new default for tasks to be applicable for all environments - even environments created after the task
* Tasks for UrbanCode Deploy can now autocomplete UCD approvals
