...
The following table is a cumulative list of fixes in the 2.5.7 version.


|  |  |
| --- | --- |
|  | Fixed UrbanCode Velocity installation issues in an Amazon Elastic Kubernetes Service. |
