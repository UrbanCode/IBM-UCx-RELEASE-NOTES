...
* Metrics table showing data across all value streams.
* New Feature: Metrics bar displaying condensed data for the displayed value stream.
* Define cycle time and lead time in your Value Stream definition.
* New plug-in framework enabling dynamic loading of plug-in containers on Kubernetes, OpenShift, and ICP.
