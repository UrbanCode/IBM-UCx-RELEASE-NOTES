...
**This article was originaly published in 2020.03.31**
...
* New Deployment Plan Task can "Run a Shell Script"
* UrbanCode Deploy Properties added to Deployment Plan Task
* Dots provide hover-over details
* Dots now display sprint and release details and support sprint coloring
* Jenkins Templates are Hidden
* Other UI Improvements
...
* + **Significant Velocity Related Performance Issues for UrbanCode Deploy prior to v7.0.5.1** 
	...
	+ **Velocity 1.5.1 Possible Loss of Access to Deployment Plans**
	A version 1.5.1 issue can cause loss of access to deployment plans for preexisting usernames containing upper case lettering (fully lowercase names/emails are unaffected). If you have users affected by this, contact support for an immediate work around. This issue will be resolved with an early release of 1.5.2.
