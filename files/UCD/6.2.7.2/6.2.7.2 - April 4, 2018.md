...
IBM UrbanCode Deploy 6.2.7.2 is a maintenance release and includes various bug fixes. This release is recommended for all customers.Release Summary
---------------
...
|  |  |
| --- | --- |
| [PI94842](http://www.ibm.com/support/docview.wss?uid=swg1PI94842) | DB2 FOR Z/OS SQL ERRORS DURING CLEANUP |
| [PI93604](http://www.ibm.com/support/docview.wss?uid=swg1PI93604) | RESTRICTING AUTHENTICATION TOKENS |
| [PI93596](http://www.ibm.com/support/docview.wss?uid=swg1PI93596) | SNAPSHOTS CLEANUP FAILS WITH CORRESPONDING HIBERNATE WARNINGS INDEPLOYSERVER.OUT |
| [PI93593](http://www.ibm.com/support/docview.wss?uid=swg1PI93593) | DEFAULT VALUES FOR PROPERTY DEFINITIONS SHOULD NOT BE CLEAREDWHEN A PATTERN IS SPECIFIED |
| [PI93403](http://www.ibm.com/support/docview.wss?uid=swg1PI93403) | REST ENDPOINT GETPROPERTY DOES NOT GET PROPERTIES INHERITED FROMTHE COMPONENT’S TEMPLATE |
| [PI92293]( SHOULD BE DEBUG) | THE LOGGING LEVEL OF “RECEIVED MESSAGE FOR UNKNOWNDIALOGUE:” IS TOO GENERAL |
| [PI92030](http://www.ibm.com/support/docview.wss?uid=swg1PI92030) | RUN OPERATIONAL PROCESS FOR MULTIPLE COMPONENTS STEP DOESN’TSHOW CORRECT VALUE FOR RUNONLYONFIRST |
| [PI91877](http://www.ibm.com/support/docview.wss?uid=swg1PI91877) | HISTORYCLEANUP INTEGRITY CONSTRAINT DS\_DISC\_EXEC\_2\_RESOURCEVIOLATED – CHILD RECORD FOUND |
| [PI91862](http://www.ibm.com/support/docview.wss?uid=swg1PI91862) | SLOWNESS LOADING THE COMPONENT PROCESS ACTIVITY TREE |
| [PI91654](http://www.ibm.com/support/docview.wss?uid=swg1PI91654) | SERVER START CAN HANG AFTER UPGRADE IF PREVIOUSLY SHUTDOWN INCRITICAL STAGE |
| [PI91194](http://www.ibm.com/support/docview.wss?uid=swg1PI91194) | RESOURCE COMPARISON AGAINST RESOURCE TEMPLATE WORKS WITHINACCURACY |
| [PI90937](http://www.ibm.com/support/docview.wss?uid=swg1PI90937) | ERROR WHEN IMPORTING PROCESS WITH UNINSTALL MULTIPLE COMPONENTSSTEP |
| [PI90754](http://www.ibm.com/support/docview.wss?uid=swg1PI90754) | REQUIRED PROPERTIES NOT TAKEN IN COUNT VIA API REQUEST |
| [PI89962](http://www.ibm.com/support/docview.wss?uid=swg1PI89962) | CANNOT CHANGE COMPONENT NAME IF COMPONENT RESOURCE IS PART OFTEMPLATE |
| [PI89922](http://www.ibm.com/support/docview.wss?uid=swg1PI89922) | NPE IN LOG FILES WHEN CREATING A SNAPSHOT AND THE COMPONENT NAMEDOES NOT EXIST. |
| [PI89617](http://www.ibm.com/support/docview.wss?uid=swg1PI89617) | RISK CHECKING FAILS WHEN ROLLING BACK ZOS COMPONENT |
| [PI89610](http://www.ibm.com/support/docview.wss?uid=swg1PI89610) | INSTALLATIONS WITH USER-DEFINED SERVER.KEYSTORE.PASSWORD DO NOTSTART AFTER UPGRADING |
| [PI88462](http://www.ibm.com/support/docview.wss?uid=swg1PI88462) | AGENT INSTALLED.PROPERTIES CORRUPTED DURING START IF LOCAL DISKIS FULL |
| [PI87727](http://www.ibm.com/support/docview.wss?uid=swg1PI87727) | DB2 FOR ZOS REQUIRES SPECIFIC SYNTAX TO PROVIDE A CAST ON SELECTSTATEMENTS |
| [PI87701](http://www.ibm.com/support/docview.wss?uid=swg1PI87701) | ENVIRONMENT CANNOT BE CREATED FROM BLUEPRINT |
| [PI87438](http://www.ibm.com/support/docview.wss?uid=swg1PI87438) | ADDING COMPONENT TEMPLATE SOURCE CONFIG PROPERTIES DOESN’TOVERRIDE COMPONENT SOURCE CONFIG PROPERTIES |
| [PI86930](http://www.ibm.com/support/docview.wss?uid=swg1PI86930) | EXECUTION LOG TIMELINE CAUSING APPARENT DEPLOYMENT SLOWNESS |
| [PI86479](http://www.ibm.com/support/docview.wss?uid=swg1PI86479) | COMPLIANCY SLOW ON SQL SERVER |
| [PI86290](http://www.ibm.com/support/docview.wss?uid=swg1PI86290) | UNABLE TO USE SYMLINKS FOR JAVA\_HOME IN UCD INSTALLER |
| [PI85981](http://www.ibm.com/support/docview.wss?uid=swg1PI85981) | SWITCHING TO BATCH EDIT MODE LETS YOU EDIT PROPERTIESINHERITED FROM A COMPONENT TEMPLATE |
| [PI84674](http://www.ibm.com/support/docview.wss?uid=swg1PI84674) | SERVICE SCRIPT MISSING PATH TO RCL IN JAVA OPTS ON UPGRADE |
| [PI84534](http://www.ibm.com/support/docview.wss?uid=swg1PI84534) | PROPERTY NAME AUTO-COMPLETE CAUSES CPU SPIKES OROUTOFMEMORYERRORS IN UCD SERVER |
| [PI84093](http://www.ibm.com/support/docview.wss?uid=swg1PI84093) | Plugin steps take a long time to complete |
| [PI83625](http://www.ibm.com/support/docview.wss?uid=swg1PI83625) | CREATING APPLICATIONS FROM A TEMPLATE REQUIRES EXTRA PERMISSIONS |
| [PI81242](http://www.ibm.com/support/docview.wss?uid=swg1PI81242) | SCHEDULE DEPLOYMENT OF UNLOCKED SNAPSHOT DOES NOT PICKSNAPSHOT’S VERSION CHANGES |
| [PI80077](http://www.ibm.com/support/docview.wss?uid=swg1PI80077) | NOT ABLE TO VIEW SOME COMPONENT TEMPLATE PROCESSES AFTERUPGRADING TO 6.2.4 |
| [PI76775](http://www.ibm.com/support/docview.wss?uid=swg1PI76775) | PROCESS EDITOR PROPERTY AUTOCOMPLETE CAN CAUSE PERFORMANCEISSUES |
| [PI59867](http://www.ibm.com/support/docview.wss?uid=swg1PI59867) | APPLICATION FAILS DUE TO CHANGES TO GENERIC PROCESS |
| [PI56724](http://www.ibm.com/support/docview.wss?uid=swg1PI56724) | Silent agent install fails to find property file if propertiesfile does not end with ‘.properties’ |
| [PI47874](http://www.ibm.com/support/docview.wss?uid=swg1PI47874) | MISSING INDEX ON VC\_PERSISTENT\_RECORD on COMMIT\_ID and PATH |
| [PI45665](http://www.ibm.com/support/docview.wss?uid=swg1PI45665) | CANNOT UPGRADE SERVER USING SQL SERVER IF PASSWORD CONTAINS “$”CHARACTER |
| [PI44544](http://www.ibm.com/support/docview.wss?uid=swg1PI44544) | INCORRECT HANDLING OF DELETED LDAP USER |
| [PI41021](http://www.ibm.com/support/docview.wss?uid=swg1PI41021) | SERVER.KEYSTORE.PASSWORD NOT SET CORRECTLY DURING SILENT INSTALL |
| [PI38654](http://www.ibm.com/support/docview.wss?uid=swg1PI38654) | EXPORTED GENERIC PROCESS DOES NOT INCLUDE OTHER REFERENCEDPROCESSES |
| [PI44546](http://www.ibm.com/support/docview.wss?uid=swg1PI44546) | ‘SET VALUE HERE’ LINKS SHOULD NOT BE PRESENT IN THE UI IF THE LEGACY OPTION ‘ENABLE “PROMPT ON USE”‘ IS DISABLED |
