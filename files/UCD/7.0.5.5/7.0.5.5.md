...
IBM UrbanCode Deploy version 7.0.5.5 is a maintenance release and includes security related fixes. This release is recommended for all customers currently on the UrbanCode Deploy 7.0.5.x stream.Release Summary
---------------
