...
IBM UrbanCode Deploy 7.0.2.3 is primarily a maintenance release and includes various bug fixes and one enhancement to the security model. This release is recommended for all customers.Release Summary
---------------
...
|  |  |
| --- | --- |
| [PH09559](http://www.ibm.com/support/docview.wss?uid=swg1PH09559) | DELETED TYPES ARE STILL SHOWING WHEN ASSIGNING |
| [PH09550](http://www.ibm.com/support/docview.wss?uid=swg1PH09550) | NULL POINTER EXCEPTION WHEN IMPORTING APPLICATION CONTAINING
“INSTALL MULTIPLE COMPONENTS” PROCESS STEP |
| [PH09371](http://www.ibm.com/support/docview.wss?uid=swg1PH09371) | DEPLOYMENT TO ZOS AGENT RUNNING ON ZRDT FAIL WITH AN ERROR THAT
AGENT IS UNLICENSED |
| [PH09250](http://www.ibm.com/support/docview.wss?uid=swg1PH09250) | ADDING SAFE EDIT CAUSES IBM DB2 ERRORS IN UCD SERVER LOGS |
| [PH08796](http://www.ibm.com/support/docview.wss?uid=swg1PH08796) | ADDING BASE RESOURCES REQUIRES LENGTHY DURATIONS OF TIME |
| [PH08115](http://www.ibm.com/support/docview.wss?uid=swg1PH08115) | AGENT LAST CONTACT VALUE NOT GETTING UPDATED FOR 6.2.7.2 AGENTS
CONNECTED TO 7.0.1.1 SERVER |
| [PH05419](http://www.ibm.com/support/docview.wss?uid=swg1PH05419) | COMPONENT PROCESS FAILS WITH “USER DOES NOT HAVE MANAGE
SNAPSHOTS PERMISSION” |
| [PI97913](http://www.ibm.com/support/docview.wss?uid=swg1PI97913) | UCD 6.2.7 CREATE ENVIRONMENT WITH OVER 20 VARIABLES WILL TIMEOUT |
| [PI88985](http://www.ibm.com/support/docview.wss?uid=swg1PI88985) | PLUGIN UPGRADE FAILS IF PLUGIN’S COMPONENT TEMPLATE HAS BEEN
DELETED |
