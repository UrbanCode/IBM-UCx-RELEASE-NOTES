...
|  |  |
| --- | --- |
| [PI94750](http://www.ibm.com/support/docview.wss?uid=swg1PI94750) | ENFORCE DEPLOYED VERSION INTEGRITY IS NOT ENFORCED WHEN UPLOADING ARTIFACTS |
| [PI85059](http://www.ibm.com/support/docview.wss?uid=swg1PI85059) | PROCESS SUCCEEDING EVEN THOUGH AGENT IS OFFLINE |
| [PI87707](http://www.ibm.com/support/docview.wss?uid=swg1PI87707) | NO RECORD OF WHO STARTED A MANUAL VERSION IMPORT |
| [PI97836](http://www.ibm.com/support/docview.wss?uid=swg1PI97836) | CANNOT CREATE APPLICATIONS, COMPONENTS, OR ENVIRONMENTS FROM UDCLIENT WITH INITIAL TEAM MAPPINGS |
| [PI98200](http://www.ibm.com/support/docview.wss?uid=swg1PI98200) | UCD SERVER WRITES EMPTY CONFIG FILE WHEN DISK IS FULL |
| [PH00264](http://www.ibm.com/support/docview.wss?uid=swg1PH00264) | URBANCODE DEPLOY DOES NOT LICENSE WEB AGENTS AUTOMATICALLY |
| [PI75849](http://www.ibm.com/support/docview.wss?uid=swg1PI75849) | UNABLE TO CONFIGURE SSL CIPHER SUITES AND PROTOCOLS FOR THE CODESTATION PORT ON AGENT RELAYS |
| [PI84768](http://www.ibm.com/support/docview.wss?uid=swg1PI84768) | DELETED ENVIRONMENT TYPES ARE DISPLAYED AND NEW ENVIRONMENTS CAN NOT BE CREATED UNLESS DEFAULT TEAM PREFERENCE IS SET TO NONE |
| [PI91452](http://www.ibm.com/support/docview.wss?uid=swg1PI91452) | TABLE WIDGET REQUESTS MORE DATA THAN IT NEEDS |
| [PI91779](http://www.ibm.com/support/docview.wss?uid=swg1PI91779) | CANNOT IMPORT PROCESS WITH FOR EACH TAG STEP |
| [PI92097](http://www.ibm.com/support/docview.wss?uid=swg1PI92097) | COMPONENT ‘CHANGES’ TAB NEEDS TO BE FULLY PAGINATED. |
| [PI93804](http://www.ibm.com/support/docview.wss?uid=swg1PI93804) | AFTER UPGRADE WEB UI NOT ACCESSIBLE BECAUSE OF A JAVA.SECURITY.KEYSTOREEXCEPTION |
| [PI93930](http://www.ibm.com/support/docview.wss?uid=swg1PI93930) | AGENT RELAY SERVICE SCRIPT FAILS WITH SYNTAX ERROR ON AIX USING KORNSHELL |
| [PI94383](http://www.ibm.com/support/docview.wss?uid=swg1PI94383) | 6.2.7 AGENTS ARE CREATED AS OFFLINE FROM THE ENVIRONMENT BLUEPRINT AGENT PROTOTYPE PATTERN |
| [PI95199](http://www.ibm.com/support/docview.wss?uid=swg1PI95199) | STEPS WITH “RUN ON CHANGED RESOURCE” ENABLED INSIDE OF A “FOR EACH TAG” STEP CAN RUN ON RESOURCES THAT WITHOUT THE SPECIFIED TAG |
| [PI96304](http://www.ibm.com/support/docview.wss?uid=swg1PI96304) | STEP OUTPUT LOG MAY BE INCOMPLETE WHEN MULTIBYTE CHARACTERS ARE INCLUDED IN OUTPUT MESSAGE |
| [PI96803](http://www.ibm.com/support/docview.wss?uid=swg1PI96803) | USERS CAN ONLY BE REMOVED FROM TEAMS BY USERS WITH THE MANAGE SECURITY PERMISSION |
| [PI98599](http://www.ibm.com/support/docview.wss?uid=swg1PI98599) | RESOURCE “ADD FROM TEMPLATE” ALLOWS DUPLICATE NAMES TO BE CREATED IN THE RESOURCE TREE |
| [PH00259](http://www.ibm.com/support/docview.wss?uid=swg1PH00259) | CREATE AUTHORIZATION REALM BUTTON CAN’T BE CLICKED |
