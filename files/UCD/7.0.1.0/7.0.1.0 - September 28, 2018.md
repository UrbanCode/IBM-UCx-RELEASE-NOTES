...
UrbanCode Deploy 7.0.1.0 now allows customers to blend Authorized Agent licenses with Floating Agent licenses (Sessions) on the same UrbanCode Deploy server.Release Summary
---------------
...
|  |  |
| --- | --- |
| [61248](http://www.ibm.com/developerworks/rfe/execute?use_case=viewRfe&CR_ID=61248) | Import LDAP groups into UrbanCode Deploy |
| [93776](http://www.ibm.com/developerworks/rfe/execute?use_case=viewRfe&CR_ID=93776) | Add resource and component mapping configuration to application export and import process |
| [117577](http://www.ibm.com/developerworks/rfe/execute?use_case=viewRfe&CR_ID=117577) | When creating a component environment property definition to store password, the type should be secure |
...
|  |  |
| --- | --- |
| [PI80533](http://www.ibm.com/support/docview.wss?uid=swg1PI80533 target=_blank) | ‘TYPE’ ACCESS CONTROL ISSUE |
| [PH02082](http://www.ibm.com/support/docview.wss?uid=swg1PH02082 target=_blank) | AGENT INSTALLATION DOCUMENTATION NEEDS UPDATE |
| [PI84539](http://www.ibm.com/support/docview.wss?uid=swg1PI84539 target=_blank) | MANAGING SNAPSHOTS REQUIRE MORE PERMISSIONS THAN “MANAGE SNAPSHOTS” |
| [PI86480](http://www.ibm.com/support/docview.wss?uid=swg1PI86480 target=_blank) | INSTALL MULTIPLE COMPONENTS STEP BY COMPONENT TAG DOES NOT SHOW COMPONENT TAG |
| [PI89092](http://www.ibm.com/support/docview.wss?uid=swg1PI89092 target=_blank) | COMPONENT TEMPLATE PROCESS PROPERTIES NOT SET WHEN RUNNING CHAIN OF COMPONENT PROCESSES |
| [PI96163](http://www.ibm.com/support/docview.wss?uid=swg1PI96163 target=_blank) | CLI TEMPLATE IS MISSING INFORMATION IN THE TEMPLATE ABOUT THE OPTIONS FOR CREATING COMPONENTS |
| [PI95195](http://www.ibm.com/support/docview.wss?uid=swg1PI95195 target=_blank) | COMPONENT PROCESS PROPERTY VALUE SET AT THE APPLICATION LEVEL INTO WRAPPED COMPONENT PROCESS |
| [PI98395](http://www.ibm.com/support/docview.wss?uid=swg1PI98395 target=_blank) | LOCKS NOT BEING RELEASED FOR FAILED OR CANCELLED PROCESS |
| [PI52268](http://www.ibm.com/support/docview.wss?uid=swg1PI52268 target=_blank) | PERFORMANCE ISSUES WITH COMPONENT CONFIGURATION ‘BASIC SETTINGS’ |
| [PI98193](http://www.ibm.com/support/docview.wss?uid=swg1PI98193 target=_blank) | INCONSISTENT BEHAVIOR BETWEEN THE UI AND CLI COMMAND ADDRESOURCETOTEAM |
