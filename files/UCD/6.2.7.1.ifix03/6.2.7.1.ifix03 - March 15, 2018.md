...
IBM UrbanCode Deploy 6.2.7.1.ifix03 is a maintenance release and includes various bug fixes. This release is recommended for all customers.Release Summary
---------------
...
|  |  |
| --- | --- |
| [PI91808](http://www.ibm.com/support/docview.wss?uid=swg1PI91808) | A SECURE PROPERTY DEFINED ON AN APPROVAL TASK WILL NOT POPULATE WITH THE DEFAULT VALUE ON APPROVAL. |
| [PI91047](http://www.ibm.com/support/docview.wss?uid=swg1PI91047) | ADD A STATUS TO A VERSION CLI REST COMMAND CAN ADD DELETED STATUS TO A VERSION |
| [PI90722](http://www.ibm.com/support/docview.wss?uid=swg1PI90722) | AGENT PROTOTYPE TAGS ARE NOT EXPORTED WITH THE RESOURCE TEMPLATE WHEN EXPORTING APPLICATION TEMPLATES |
| [PI90692](http://www.ibm.com/support/docview.wss?uid=swg1PI90692) | WHEN RESTORING ARCHIVED COMPONENT VERSION SHOULD BE PRE-POPULATED WITH ONLY THE ARCHIVE’S FILE NAME. |
| [PI90420](http://www.ibm.com/support/docview.wss?uid=swg1PI90420) | PERFORMANCE ISSUES WHEN RUNNING MANY COMPONENT PROCESSES FROM AN APPLICATION PROCESS |
| [PI90236](http://www.ibm.com/support/docview.wss?uid=swg1PI90236) | UNABLE TO PERFORM DEPLOYMENTS AFTER UPGRADING TO 6.2.6.1 OR 6.2.7.0 |
| [PI89116](http://www.ibm.com/support/docview.wss?uid=swg1PI89116) | PROCESS RUNS SUCCESSFULLY WHEN COMPONENT ENVIRONMENT PROPERTY IS NOT DEFINED ON AN ENVIRONMENT |
| [PI89091](http://www.ibm.com/support/docview.wss?uid=swg1PI89091) | WRONG JAVA HOME CAN RESULT IN FAILED AGENT UPGRADES |
| [PI87748](http://www.ibm.com/support/docview.wss?uid=swg1PI87748) | UNABLE TO SELECT RESOURCES FOR COMPARISON IF THEIR NAMES START WITH THE SAME SEQUENCE OF CHARACTERS |
| [PI87016](http://www.ibm.com/support/docview.wss?uid=swg1PI87016) | PERMISSION DENIED WHEN USING UNIX IMPERSONATION |
| [PI86606](http://www.ibm.com/support/docview.wss?uid=swg1PI86606) | CHANGING THE COMPONENT PROCESS TYPE RESULTS IN DEPLOYMENT ERRORS |
| [PI86070](http://www.ibm.com/support/docview.wss?uid=swg1PI86070) | COMPONENT VERSION CLEANUP HAS POOR PERFORMANCE WITH LARGE NUMBERS OF VERSIONS |
| [PI84468](http://www.ibm.com/support/docview.wss?uid=swg1PI84468) | ARTIFACT CLEANUP QUERY CAN BE OPTIMIZED |
| [PI84343](http://www.ibm.com/support/docview.wss?uid=swg1PI84343) | POST PROCESSING SCRIPT DROP DOWN AND BUTTONS DISAPPEARING IN SHELL STEP PROPERTIES WHEN CLOSED WITH THE ‘X’ |
| [PI83166](http://www.ibm.com/support/docview.wss?uid=swg1PI83166) | REMOVING A VERSION MAPPING FROM A SNAPSHOT IN THE UI, AND THEN ADDING A VERSION WITH THE CLI RESULTS IN INCONSISTENT ORDERERING |
| [PI77621](http://www.ibm.com/support/docview.wss?uid=swg1PI77621) | DEPLOYMENT CLEANUP HISTORY NOT REMOVING DEPLOYMENTS ON MYSQL |
| [PI68181](http://www.ibm.com/support/docview.wss?uid=swg1PI68181) | ERROR WHEN UPGRADING INACTIVE UCD SERVERS |
| [PI42861](http://www.ibm.com/support/docview.wss?uid=swg1PI42861) | UNRESOLVED PROPERTY ERROR FOR PROPERTY WHICH HAS BEEN REMOVED |
| [PI91641](http://www.ibm.com/support/docview.wss?uid=swg1PI91641) | SORTING TOKENS BY CREATION DATE RESULTS IN : COULD NOT RESOLVE PROPERTY: CREATEDDATE OF: COM.URBANCODE.SECURITY.AUTHTOKEN |
...
| [PI94407](http://www.ibm.com/support/docview.wss?uid=swg1PI94407) | RUNNING A PROCESS THAT RESOLVES A RESOURCE PROPERTY CAUSES A NONUNIQUERESULTEXCEPTION: QUERY DID NOT RETURN A UNIQUE RESULT: # |
| [PI95009](http://www.ibm.com/support/docview.wss?uid=swg1PI95009) | SEND HTTP PLUGIN DISPLAYING CLEAR PASSWORD IN INPUT PROPERTIES UI |
...
### Severe Defect in Unfixed 6.2.7.1, 6.2.7.1.ifix01, and 6.2.7.1.ifix02


6.2.7.1 contains APAR [PI95009](http://www.ibm.com/support/docview.wss?uid=swg1PI95009), which can cause step input properties to appear in plain text instead of being obfuscated. To avoid APAR PI95009, install 6.2.7.1.ifix03.
### Severe Defect in Unfixed 6.2.7.1 and Unfixed 6.2.7.1.ifix01


6.2.7.1 contains APAR [PI94407](http://www.ibm.com/support/docview.wss?uid=swg1PI94407), which can cause processes that resolve resource properties to fail. To avoid APAR PI94407, either implement the workaround or install 6.2.7.1.ifix03.
### Severe Defect in Unfixed 6.2.7.1


6.2.7.1 contains APAR [PI93742](http://www.ibm.com/support/docview.wss?uid=swg1PI93742), which can cause plugin steps to fail even if they have actually succeed. To avoid APAR PI93742, upgrade 6.2.7.1 to 6.2.7.1.ifix03, and then upgrade all agents.
