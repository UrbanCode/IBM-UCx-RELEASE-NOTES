...
IBM UrbanCode Deploy 6.2.7.3 is a maintenance release and includes various bug fixes. This release is recommended for all customers.Release Summary
---------------
...
|  |  |
| --- | --- |
| [PI94915](http://www.ibm.com/support/docview.wss?uid=swg1PI94915) | PROCESS EDITOR CAN FREEZE BROWSER IF PROCESS CONTAINS A NOTE UNDER SOME CIRCUMSTANCES |
| [PI92552](http://www.ibm.com/support/docview.wss?uid=swg1PI92552) | SOME LINUX/UNIX VARIANTS FAIL WITH “./INSTALL-AGENT.SH: 21: ./INSTALL-AGENT.SH: FUNCTION: NOT FOUND” |
| [PI92285](http://www.ibm.com/support/docview.wss?uid=swg1PI92285) | PROCESSES THAT REFERENCE NULL PLUGINCOMMANDS WILL BREAK THE PROCESSPLUGINUSAGEMETADATAGENERATOR |
| [PI92116](http://www.ibm.com/support/docview.wss?uid=swg1PI92116) | RUNNING HISTORY CLEANUP WITH AN EXISTING ENVIRONMENT APPROVAL TASK ON AN OLDER GHOSTED ENVIRONMENT BREAKS THE WORK ITEMS PAGE |
| [PI91830](http://www.ibm.com/support/docview.wss?uid=swg1PI91830) | CANNOT VIEW APPLICATION LOG WITH BLANK NOTE STEP PRESENT |
| [PI88236](http://www.ibm.com/support/docview.wss?uid=swg1PI88236) | AGENT UPGRADE FAILS ON 32-BIT OS |
| [PI84809](http://www.ibm.com/support/docview.wss?uid=swg1PI84809) | DEPLOYMENT HISTORY CLEANUP UI PROGRESS BAR STUCK |
| [PI83815](http://www.ibm.com/support/docview.wss?uid=swg1PI83815) | USERS NEED VIEW PERMISSION TO TOP LEVEL RESOURCES |
| [PI83932](http://www.ibm.com/support/docview.wss?uid=swg1PI83932) | CREATE COMPONENT STEP DOESN’T SET THE BASEPATH PROPERTY FOR FILE SYSTEM SOURCE CONFIG TYPE |
| [PI80376](http://www.ibm.com/support/docview.wss?uid=swg1PI80376) | UC VERSION IMPORT USER MISSING PERMISSION FOR DOCKER |
| [PI80130](http://www.ibm.com/support/docview.wss?uid=swg1PI80130) | APPLICATION TEMPLATE PROCESS CAN DEPLOY INDIVIDUAL COMPONENT DEPLOYMENTS IF THEY USE CLIPBOARD |
| [PI74398](http://www.ibm.com/support/docview.wss?uid=swgPI74398) | ENVIRONMENT PROPERTY MISMATCH IN CONFIGURATION TAB |
| [PI71048](http://www.ibm.com/support/docview.wss?uid=swg1PI71048) | ISSUES SCHEDULING A RECURRING SECURITY REPORT |
| [PI70971](http://www.ibm.com/support/docview.wss?uid=swg1PI70971) | RESOURCE FILTER DOES NOT WORK WHEN CHOOSING BASE RESOURCE WHEN CREATING ENVIRONMENT FROM BLUEPRINT |
| [PI69502](http://www.ibm.com/support/docview.wss?uid=swg1PI69502) | CANNOT VIEW COMPONENT CONFIGURATION PAGE |
| [PI67025](http://www.ibm.com/support/docview.wss?uid=swg1PI67025) | SUDO IMPERSONATION FAILING WITH NULLPOINTEREXCEPTION |
| [PI57779](http://www.ibm.com/support/docview.wss?uid=swg1PI57779) | REMOVING IMPERSONATION DOES NOT CLEAR DEFAULT IMPERSONATION SETTINGS |
