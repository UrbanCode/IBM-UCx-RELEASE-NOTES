...
IBM UrbanCode Deploy 7.0.3.1 is primarily a maintenance release and includes various bug fixes. This release is recommended for all customers.Release Summary
---------------
...
|  |  |
| --- | --- |
| [PH13888](http://www.ibm.com/support/docview.wss?uid=swg1PH13888) | UPDATING ENVIRONMENT PROPERTY FOR MULTIPLE COMPONENTS USING 'ALL COMPONENTS' SETTING RESULTS IN WEBUI HANGING |
| [PH11860](http://www.ibm.com/support/docview.wss?uid=swg1PH11860) | WAS - DEPLOY PLUGIN UPGRADE PROCESS RUNS INCREDIBLY SLOWLY |
| [PH11791](http://www.ibm.com/support/docview.wss?uid=swg1PH11791) | APPLICATION PROCESS STEP LOG IS UNORDERED AFTER RUNNING A PROCESS |
| [PH11513](http://www.ibm.com/support/docview.wss?uid=swg1PH11513) | ADD TEAMS COMBO BOX DOES NOT ALLOW FOR PARTIAL MATCHES, MATCHES BY CHARACTER |
| [PH10772](http://www.ibm.com/support/docview.wss?uid=swg1PH10772) | LONG GROUP NAME CAUSES REST FAILURE IN CLI API RELATED TO GROUP ON DB2 |
| [PH10725](http://www.ibm.com/support/docview.wss?uid=swg1PH10725) | REMOVE FILTER BUTTON OVERLAPS APPLICATION FIELD ON IE11 |
| [PH10664](http://www.ibm.com/support/docview.wss?uid=swg1PH10664) | DELETING AN AGENT FROM A SERVER INSTALLED ON Z/LINUX |
| [PH10616](http://www.ibm.com/support/docview.wss?uid=swg1PH10616) | ROLLING BACK DEPLOYMENT IN ONE ENVIRONMENT CHANGES THE COMPLIANCE STATUS OF ANOTHER ENVIRONMENT |
| [PH08374](http://www.ibm.com/support/docview.wss?uid=swg1PH08374) | Running the 'Upload Artifacts' Step in UrbanCode Deploy 7.0.1.x fails with: java.io.IOException: Not authorized: versionID> |
| [PH06993](http://www.ibm.com/support/docview.wss?uid=swg1PH06993) | IMPERSONATING WITH INVALID WORKING DIRECTORY DEFAULTS WORKING DIRECTORY TO AGENT/BIN |
| [PH04513](http://www.ibm.com/support/docview.wss?uid=swg1PH04513) | LOGS ARE NOT DELETED FROM AGENT /VAR/TEMP IN CLUSTERED SCENARIO |
| [PI80921](http://www.ibm.com/support/docview.wss?uid=swg1PI80921) | CALENDAR VIEW RECURRING PROCESSES ARE MISSING NAME |
| [PH04513](http://www.ibm.com/support/docview.wss?uid=swg1PH04513) | LOGS ARE NOT DELETED FROM AGENT /VAR/TEMP IN CLUSTERED SCENARIO |
| [PH11177](http://www.ibm.com/support/docview.wss?uid=swg1PH11177) | UNABLE TO SET PROPERTIES WHEN USING REST API TO CREATE APPLICATION FROM APP TEMPLATE |
...
If you are upgrading from version 6.2.3.0 and earlier, servers and relays must be upgraded at the same time. Agents connected through relays may not connect successfully until both server and relay are upgraded. This is due to an incompatibility between versions of a library used by UCD.
...
For fixes contained in this release, and any known issues, review the [release notes](https://www.ibm.com/cloud/urbancodewhats-new/whats-new-urbancode-deploy-7-0-3-0/release-notes).
...
This release is available for download from [Fix Central](https://www-945.ibm.com/support/fixcentral/swg/downloadFixes?parent=ibm~Rational&product=ibm/Rational/IBM+UrbanCode+Deploy&release=All&platform=All&function=fixId&fixids=7.0.3.1-IBM-UrbanCode-Deploy&includeRequisites=1&includeSupersedes=0&downloadMethod=http), requiring authentication.
...
To learn more about new enhancements in this release, see [What’s New](https://www.ibm.com/cloud/urbancodewhats-new/whats-new-urbancode-deploy-7-0-3-1/).
