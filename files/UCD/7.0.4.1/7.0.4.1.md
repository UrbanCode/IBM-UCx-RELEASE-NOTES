...
|  |  |
| --- | --- |
| [PH17277](http://www.ibm.com/support/docview.wss?uid=swg1PH17277) | WITH MULTIPLE LDAP GROUP REALMS MAPPED TO AN USER REALM LOGIN CAN FAIL IF THE USER IS ONLY IN ONE LDAP GROUP REALM |
| [PH16696](http://www.ibm.com/support/docview.wss?uid=swg1PH16696) | LOW SCREEN RESOLUTION HIGH BROWSER ZOOM, AND SCROLLING DOWN A LIST, WILL MAKE THE MENU HEADER POP UP OVER THE LISTED OBJECTS |
| [PH16054](http://www.ibm.com/support/docview.wss?uid=swg1PH16054) | URBANCODE DEPLOY WEB AGENTS ARE NOT RESOLVING THE AGENT RESOURCE WORKING DIRECTORY WITHOUT / AT THE END OF PATH |
| [PH16030](http://www.ibm.com/support/docview.wss?uid=swg1PH16030) | UC AUTO DISCOVER ROLE IS NOT GIVEN 'MANAGE PROPERTIES' PERMISSION TO RESOURCES ON UPGRADE |
| [PH15905](http://www.ibm.com/support/docview.wss?uid=swg1PH15905) | SILENT AGENT INSTALLATION FAILING WHEN AGENT.SERVICE.AUTOSTART IS DEFINED AS TRUE/FALSE INSTEAD OF YES/NO |
| [PH15806](http://www.ibm.com/support/docview.wss?uid=swg1PH15806) | CANCELED PROCESSES DO NOT REMOVE ALL TEMPORARY FILES FROM THE AGENT TEMP DIRECTORY |
| [PH15666](http://www.ibm.com/support/docview.wss?uid=swg1PH15666) | ACTIVE CHECK BOX IS ALWAYS CHECKED IN THE EDIT WINDOW FOR CLUSTER MEMBERS UNDER THE NETWORK TAB |
| [PH15581](http://www.ibm.com/support/docview.wss?uid=swg1PH15581) | DB2 FOR Z\OS THE ALTER TABLE STATEMENT CANNOT DROP MULTIPLE COLUMNS. SEPARATE ALTER TABLE STEPS ARE REQUIRED. |
| [PH15288](http://www.ibm.com/support/docview.wss?uid=swg1PH15288) | DEPLOYMENT HISTORY CLEANUP DOES NOT CLEAN UP COMPONENT PROCESSES RUN OUTSIDE OF AN APPLICATION PROCESS |
| [PH14934](http://www.ibm.com/support/docview.wss?uid=swg1PH14934) | OPTIONAL PROPERTIES SHOULD NOT BE REQUIRED BY REST ENDPOINT FOR IMPORTING NEW COMPONENT VERSIONS |
| [PH14713](http://www.ibm.com/support/docview.wss?uid=swg1PH14713) | NULL POINTER WHEN IMPORTING APPLICATION WITH SNAPSHOTS |
| [PH14623](http://www.ibm.com/support/docview.wss?uid=swg1PH14623) | DEFAULT TEAMS SET IN USER PREFERENCES DO NOT WORK FOR GENERIC
PROCESSES |
| [PH14656](http://www.ibm.com/support/docview.wss?uid=swg1PH14656) | NULL POINTER EXCEPTION ON PROCESS STEP FOR OPERATIONAL PROCESS WITH "RUN IF COMPONENTS CHANGE" CHECKED |
| [PH14592](http://www.ibm.com/support/docview.wss?uid=swg1PH14592) | RESOURCESYNCHSERVICE CACHE TOO MANY PROPERTYSHEETGROUPS INTO MEMORY WHICH CAN DEGRADE PERFORMANCE ON RESOURCE TREE |
| [PH14011](http://www.ibm.com/support/docview.wss?uid=swg1PH14011) | LICENSE RELATED NULL POINTER EXCEPTIONS FILLING UP LOG FILE |
| [PH12994](http://www.ibm.com/support/docview.wss?uid=swg1PH12994) | COMPONENT CREATED FROM COMPONENT TEMPLATE CAN SHOW ERRONEOUS RECORDS FOR TEMPLATE VERSION |
| [PH12904](http://www.ibm.com/support/docview.wss?uid=swg1PH12904) | AFTER UPGRADING TO 7.0.2.3, AGENT INSTALLATION VIA SSH FAILS WITH POPUP ALERT "ID TO LOAD IS REQUIRED FOR LOADING" |
| [PH12857](http://www.ibm.com/support/docview.wss?uid=swg1PH12857) | NO NOTIFICATION ABOUT TO CREATE AN OBJECT WITHOUT TEAM MAPPED WHEN IT SHOULD BE ACTUALLY MAPPED. |
| [PH11938](http://www.ibm.com/support/docview.wss?uid=swg1PH11938) | CHANGES TO ENVIRONMENT PROPERTIES DEFINED BY A COMPONENT ARE NOT PROPAGATED CORRECTLY TO ENVIRONMENT |
| [PI90702](http://www.ibm.com/support/docview.wss?uid=swg1PI90702) | DATE INPUT FIELD NOT WORKING FOR IE11 |
| [PI89453](http://www.ibm.com/support/docview.wss?uid=swg1PI89453) | WHEN IMPORTING A USER FROM LDAP, THE USER IS CREATED IN THE DATABASE BEFORE ANY LDAP QUERY ERROR IS DETECTED. |
...
This release is available for download from [Fix Central](https://www-945.ibm.com/support/fixcentral/swg/downloadFixes?parent=ibm~Rational&product=ibm/Rational/IBM+UrbanCode+Deploy&release=All&platform=All&function=fixId&fixids=7.0.4.1-IBM-UrbanCode-Deploy&includeRequisites=1&includeSupersedes=0&downloadMethod=http), requiring authentication.
