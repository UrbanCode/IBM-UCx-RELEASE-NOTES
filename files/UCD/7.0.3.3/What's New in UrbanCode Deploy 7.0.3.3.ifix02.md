...
7.0.3.3 has been replaced by 7.0.3.3.ifix02 as of October 20th, 2019. All customers currently on 7.0.3.3 are recommended to upgrade to 7.0.3.3.ifix02. More information can be found on the Release Notes page.Release Summary
---------------

  
Recommended fixes for Urbancode Deploy.Release Notes
-------------
...
|  |  |
| --- | --- |
| [PH13982](http://www.ibm.com/support/docview.wss?uid=swg1PH13982) | When selecting any sub-resource on a resource tree, the Resource Tree collapses to the top level resource |
| [PH13898](http://www.ibm.com/support/docview.wss?uid=swg1PH13898) | RESOURCE SYNC SERVICE NOT SYNCHRONIZED ACROSS HA INSTANCES |
| [PH13751](http://www.ibm.com/support/docview.wss?uid=swg1PH13751) | WHEN UPGRADING FROM UCD V 6.2.7 TO VERSION 7.0.1 UNKNOWN UCDAGENTLICENSETYPE: AGENT\_PVU |
| [PH13734](http://www.ibm.com/support/docview.wss?uid=swg1PH13734) | COPY OF COMPONENT IS NOT COPYING CONFIGURATION TEMPLATES OF THE COMPONENT |
| [PH13398](http://www.ibm.com/support/docview.wss?uid=swg1PH13398) | CLI API GETSNAPSHOTVERSIONS RETURNS DIFFERENT JSON OBJECT IN V7.0.2.2 THAN WITH V6.2.5 |
| [PH13078](http://www.ibm.com/support/docview.wss?uid=swg1PH13078) | HTTP ENCODING OF WHITESPACE CHARACTER DURING UCD STARTUP RESULTS IN FILENOTFOUNDEXCEPTION |
| [PH12905](http://www.ibm.com/support/docview.wss?uid=swg1PH12905) | DELETING A COPIED STEP FROM CLIPBOARD FAILS IN LANGUAGES OTHER THAN ENGLISH |
| [PH10787](http://www.ibm.com/support/docview.wss?uid=swg1PH10787) | IF ENVIRONMENTS ARE PROVISIONED FROM BPD ,WHEN DEPLOYMENT IS CANCELLED TOKEN LICENSES ARE NOT GETTING RELEASED BY AGENTS. |
| [PH09485](http://www.ibm.com/support/docview.wss?uid=swg1PH09485) | USERS WITHOUT COMPONENT TEMPLATE READ PERMISSION CANNOT RUN COMPONENT PROCESSES FROM THE SAME TEMPLATE |
| [PH09250](http://www.ibm.com/support/docview.wss?uid=swg1PH09250) | ADDING SAFE EDIT CAUSES IBM DB2 ERRORS IN UCD SERVER LOGS |
| [PH09239](http://www.ibm.com/support/docview.wss?uid=swg1PH09239) | SELECT COMPONENT VERSION DIALOG NOT DISPLAYING THE WHOLE VERSION NUMBER FOR VERSIONS WITH LONG NAMES |
| [PH06338](http://www.ibm.com/support/docview.wss?uid=swg1PH06338) | CANCEL APPLICATION PROCESS EXECUTION WITH "INSTALL MULTIPLE COMPONENTS" STEP , SHOULD CANCEL ALL COMPONENT PROCESSES ALSO |
| [PH01967](http://www.ibm.com/support/docview.wss?uid=swg1PH01967) | ERROR MESSAGE NOT UTF-8 ON Z/OS WHEN USING IMPERSONATION |
| [PI56142](http://www.ibm.com/support/docview.wss?uid=swg1PI56142) | PERFORMANCE DELAYS IN PROCESS DESIGNER WHEN MOVING THROUGH PROCESS PROPERTIES |


7.0.3.3 has been replaced by 7.0.3.3.ifix01 in order to provide a fix for the following issue:
...
7.0.3.3 has been been ifixed again. The following issues are fixed in 7.0.3.3.ifix02:
...
This release is available for download from [Fix Central](https://www-945.ibm.com/support/fixcentral/swg/downloadFixes?parent=ibm~Rational&product=ibm/Rational/IBM+UrbanCode+Deploy&release=All&platform=All&function=fixId&fixids=7.0.3.3.ifix02-IBM-UrbanCode-Deploy&includeRequisites=1&includeSupersedes=0&downloadMethod=http), requiring authentication.
