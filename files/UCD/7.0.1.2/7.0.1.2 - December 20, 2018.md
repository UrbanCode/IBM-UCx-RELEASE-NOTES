...
IBM UrbanCode Deploy 7.0.1.2 is a maintenance release and includes various bug fixes. This release is recommended for all customers.Release Summary
---------------
...
|  |  |
| --- | --- |
| [PH05739](http://www.ibm.com/support/docview.wss?uid=swg1PH05739) | PROPERTY FIELDS ARE NOT DISPLAYED IN THE WIZARD FOR CREATING AN
APPLICATION FROM A TEMPLATE |
| [PH04974](http://www.ibm.com/support/docview.wss?uid=swg1PH04974) | PROPERTY VALUE NOT DISPLAYED WHEN ASSIGNING TEMPLATE TO
COMPONENT |
| [PH04393](http://www.ibm.com/support/docview.wss?uid=swg1PH04393) | UPDATING ONE COMPONENT ENVIRONMENT PROPERTY CAUSES OTHER
COMPONENT ENVIRONMENT PROPERTY TO BLANK OUT. |
| [PH04216](http://www.ibm.com/support/docview.wss?uid=swg1PH04216) | USER BELONGING TO GROUPS CAN NO LONGER ADD TEAMS TO UCD OBJECTS
EVEN IF THEY HAVE MANAGE TEAM PERMISSION. |
| [PH03183](http://www.ibm.com/support/docview.wss?uid=swg1PH03183) | SAVING COMPONENT CHANGES REMOVES VALUES INHERITED FROM
THECOMPONENT TEMPLATE ON THE ENVIRONMENT. |
| [PH02395](http://www.ibm.com/support/docview.wss?uid=swg1PH02395) | INCORRECT UI PERMISSIONS FOR REMOVING BASE RESOURCES FROM AN
ENVIRONMENT |
| [PH02288](http://www.ibm.com/support/docview.wss?uid=swg1PH02288) | CANNOT SPECIFY DEFAULT RESOURCE IN CREATEGENERICPROCESS AND
/CLI/PROCESS/CREATE |
| [PH01983](http://www.ibm.com/support/docview.wss?uid=swg1PH01983) | NO DEFAULT NOTIFICATION TEMPLATE FOR APPROVAL COMPLETED |
| [PH01903](http://www.ibm.com/support/docview.wss?uid=swg1PH01903) | PERFORMANCE ISSUES WHEN REDACTING SECURE PROPERTIES |
| [PH01456](http://www.ibm.com/support/docview.wss?uid=swg1PH01456) | USER UNABLE TO SEE ENVIRONMENT DEPLOYMENT SUMMARY DUE TO ERROR
IN THE INVENTORY DETAILS SECTION |
| [PH00376](http://www.ibm.com/support/docview.wss?uid=swg1PH00376) | DUPLICATED FIELDS SHOWN IN ENVIRONMENT CREATION DIALOG |
| [PH00227](http://www.ibm.com/support/docview.wss?uid=swg1PH00227) | FAILING TO COMPLETE PROCESS DUE TO TX STATE IS NOT CLEAN ERROR |
| [PI98120](http://www.ibm.com/support/docview.wss?uid=swg1PI98120) | STEPS SHOW AS FAILED AFTER THE PROCESS WAS CANCELLED |
| [PI98033](http://www.ibm.com/support/docview.wss?uid=swg1PI98033) | PROPERTIES NOT FOLLOWING ORDER OF PRECEDENCE AS DESCRIBED IN THE
DOCUMENTATION |
| [PI95030](http://www.ibm.com/support/docview.wss?uid=swg1PI95030) | CUSTOMERS THAT UPGRADE FROM A VERSION OF UCD < 6.2.0 WILL BE
MISSING INDICES |
| [PI89045](http://www.ibm.com/support/docview.wss?uid=swg1PI89045) | COMPONENT VERSION CREATION AND DEPLOYMENT RACE CONDITION |
| [PI84762](http://www.ibm.com/support/docview.wss?uid=swg1PI84762) | BASE RESOURCE PROPERTIES ARE NOT VISIBLE ON A SNAPSHOT’S
CONFIGURATION PAGE |
| [PI70146](http://www.ibm.com/support/docview.wss?uid=swg1PI70146) | RESTARTING AN AGENT WHILE RUNNING A PLUGIN STEP CAUSES THE STEP
TO HANG INDEFINITELY |
| [PH06615](http://www.ibm.com/support/docview.wss?uid=swg1PH06615) | DELETED TYPES ARE STILL VISIBLE IN THE UCD OBJECT TEAMS SELECTOR |
