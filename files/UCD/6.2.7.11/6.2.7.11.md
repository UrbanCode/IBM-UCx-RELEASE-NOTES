...
IBM UrbanCode Deploy version 6.2.7.11 is a maintenance release and includes security related fixes. This release is recommended for all customers currently on the UrbanCode Deploy 6.2.7.x stream.Release Summary
---------------
