...
With the 7.0.3.2 release, users now have access to a containerized Distributed Front End (DFE) server. [Click here](https://developer.ibm.com/urbancode/2019/05/23/distributed-front-end-server/) to learn more about DFE.Release Summary
---------------
...
|  |  |
| --- | --- |
| [PH12814](http://www.ibm.com/support/docview.wss?uid=swg1PH12814) | EACH PAGE LOAD TAKES SEVERAL (5 TO 20) SECONDS |
| [PH12486](http://www.ibm.com/support/docview.wss?uid=swg1PH12486) | ERROR LOG WINDOW IS SHRUNK IN SIZE WHEN CHANGING THE ZOOM LEVEL ON THE BROWSER |
| [PH12462](http://www.ibm.com/support/docview.wss?uid=swg1PH12462) | EXISTING PLUGINS FAIL TO LOAD WHEN IMPORTING AN ENVIRONMENT FROM JSON |
| [PH12129](http://www.ibm.com/support/docview.wss?uid=swg1PH12129) | DELETED ENVIRONMENTS APPEAR IN UCD SECURITY REPORT WHEN DOWNLOADING CSV |
| [PH11679](http://www.ibm.com/support/docview.wss?uid=swg1PH11679) | DEPLOYMENT FAILS WHILE USING FOR EACH TAG FOR AN UNRELATED OFFLINE AGENT |
| [PH11665](http://www.ibm.com/support/docview.wss?uid=swg1PH11665) | TEAMS ARE NOT INHERITED AT THE CHILD RESOURCE ADDED BY COMPARE OR SYNCHRONIZE ACTION |
| [PH11630](http://www.ibm.com/support/docview.wss?uid=swg1PH11630) | COMPONENT ENVIRONMENT SELECTION PROPERTIES WITH NO DEFAULT DISPLAYS THE FIRST VALUE WHEN VIEWED IN ENV COMPONENT PROPS |
| [PH11361](http://www.ibm.com/support/docview.wss?uid=swg1PH11361) | COMPONENT VERSION CLEANUP IS NOT PROPERLY ORDERED |
| [PH11030](http://www.ibm.com/support/docview.wss?uid=swg1PH11030) | WHEN APPLICATION TYPE IS DELETED AND RECREATED , IMPORTING APPLICATIONS WITH SAME APPLICATION TYPE NAME IS GIVING ERROR. |
| [PH09234](http://www.ibm.com/support/docview.wss?uid=swg1PH09234) | DELETING COMPONENT'S ENVIRONMENT PROPERTY DEFINITION DOES NOT REVERT TO USING ITS TEMPLATE'S ENVIRONMENT PROPERTY DEFINITION |
| [PH08798](http://www.ibm.com/support/docview.wss?uid=swg1PH08798) | SOURCE CONFIG PLUGIN MIGRATOR DOES NOT CHECK A COMPONENT'S COMPONENT TEMPLATE'S PROPSHEET VALUES |
| [PI94048](http://www.ibm.com/support/docview.wss?uid=swg1PI94048) | USERS UNABLE TO HOVER OVER LDAP GROUPS IN PROFILE TO SEE USERS. |
| [PI92489](http://www.ibm.com/support/docview.wss?uid=swg1PI92489) | AFTER SCHEDULING A PROCESS TO RUN AT 12:00AM, IT DOES NOT SHOW UP CORRECTLY ON THE CALENDAR. |
| [PI91531](http://www.ibm.com/support/docview.wss?uid=swg1PI91531) | EXTRA WINDOWS SERVICE INSTALLATION FILE |
| [PH14768](http://www.ibm.com/support/docview.wss?uid=swg1PH14768) | AVOID LOADING FULL AGENT INSTANCES BY OPTIMIZING DYNAMIC GROUP SYNCHRONIZATION |
| [PH08408](http://www.ibm.com/support/docview.wss?uid=swg1PH08408) | COMPONENTS WITHOUT THE CORRESPONDING SOURCE CONFIG PLUGIN PROPSHEET WILL CAUSE PLUGIN UPGRADE TO FAIL WITH NPE |
| [PH09190](http://www.ibm.com/support/docview.wss?uid=swg1PH09190) | SOURCE CONFIG PLUGIN MIGRATOR USES OLD PROP DEF SHEET TO VALIDATE PROPERTIES |
...
This release is available for download from [Fix Central](https://www-945.ibm.com/support/fixcentral/swg/downloadFixes?parent=ibm~Rational&product=ibm/Rational/IBM+UrbanCode+Deploy&release=All&platform=All&function=fixId&fixids=7.0.3.2-IBM-UrbanCode-Deploy&includeRequisites=1&includeSupersedes=0&downloadMethod=http), requiring authentication.
