...
A cumulative list of fixes in this release, and any future fix packs can be found [in this document](https://www.ibm.com/cloud/urbancodewhats-new/fix-list/).


|  |  |
| --- | --- |
| [PH11608](http://www.ibm.com/support/docview.wss?uid=swg1PH11608) | WINDOWS AGENT UPGRADE TO 7.0.2.2 IS FAILING IF AGENT INSTALLATION PATH CONTAINS SPACES IN IT . |
| [PH10460](http://www.ibm.com/support/docview.wss?uid=swg1PH10460) | ENVIRONMENT COLORS SELECTED IN OLDER VERSIONS DEFAULT TO CERULEAN IN VERSIONS POST 7.0.0.0 |
| [PI96562](http://www.ibm.com/support/docview.wss?uid=swg1PI96562) | APPLY CONFIGURATION STEP FAILS BUT, BUT THE COMPONENT CONFIGURATION INVENTORY IS STILL UPDATED |
| [PI94893](http://www.ibm.com/support/docview.wss?uid=swg1PI94893) | CHECKACCESS PROGRAM IS NOT REMOVED FROM THE BIN DIRECTORY AFTER AGENT UGPRADING |
| [PH06740](http://www.ibm.com/support/docview.wss?uid=swg1PH06740) | TEAM SELECTOR MAY NOT SHOW ALL TYPES FOR WHICH THE USER HAS MANAGE TEAM PERMISSION |
| [PH06615](http://www.ibm.com/support/docview.wss?uid=swg1PH06615) | DELETED TYPES ARE STILL VISIBLE WHEN ASSIGNING TEAMS AND TYPES TO A UCD OBJECT |
| [PH05675](http://www.ibm.com/support/docview.wss?uid=swg1PH05675) | ON ANY UCD OBJECT CONFIGURATION, USERS ARE ABLE TO ADD ALL CONFIGURATION TYPES. |
| [PH04216](http://www.ibm.com/support/docview.wss?uid=swg1PH04216) | USER BELONGING TO GROUPS CAN NO LONGER ADD TEAMS TO UCD OBJECTS EVEN IF THEY HAVE MANAGE TEAM PERMISSION |
| [PH05178](http://www.ibm.com/support/docview.wss?uid=swg1PH05178) | CANNOT ADD TEAM AS CUSTOM TYPE WHEN CREATING ENV TEMPLATE |


The 7.0.3.0 release has been replaced by the 7.0.3.0.ifix01 release. The ifix include all noted fixes for 7.0.3.0 as well as the following fixes.


|  |  |
| --- | --- |
| [PH13992](http://www.ibm.com/support/docview.wss?uid=swg1PH13992) | TEAM SELECTOR DOES NOT DISPLAY TEAM DROPDOWN WHEN CREATING COMPONENT OR APPLICATION FROM TEMPLATE |
...
This release is available for download from [Fix Central](https://www-945.ibm.com/support/fixcentral/swg/downloadFixes?parent=ibm~Rational&product=ibm/Rational/IBM+UrbanCode+Deploy&release=All&platform=All&function=fixId&fixids=7.0.3.0.ifix01-IBM-UrbanCode-Deploy&includeRequisites=1&includeSupersedes=0&downloadMethod=http), requiring authentication.
...
To learn more about new enhancements in this release, see [What’s New](https://www.ibm.com/cloud/urbancodewhats-new/whats-new-urbancode-deploy-7-0-3-0/).
